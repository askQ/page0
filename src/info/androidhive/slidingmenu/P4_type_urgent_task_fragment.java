...
public class P4_type_urgent_task_fragment extends Fragment {
	...
	public P4_type_urgent_task_fragment(){}
	
	@Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
            Bundle savedInstanceState) {
 
        View rootView = inflater.inflate(R.layout.type_urgent, container, false);
